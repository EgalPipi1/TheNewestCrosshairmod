...
public class CrosshairConfig {
    ...
    public static int size = 16;        // crosshair sprite size in pixels (16 = vanilla size)
    public static int thickness = 2;    // reserved for future use
    public static int color = 0xFFFFFFFF; // ARGB tint (0xFFFFFFFF = untinted vanilla look)
